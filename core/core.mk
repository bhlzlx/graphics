...
$(IntermediateDirectory)/common_ResourcePool.cpp$(ObjectSuffix): common/ResourcePool.cpp $(IntermediateDirectory)/common_ResourcePool.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "E:/projects/graphics/core/common/ResourcePool.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/common_ResourcePool.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/common_ResourcePool.cpp$(DependSuffix): common/ResourcePool.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/common_ResourcePool.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/common_ResourcePool.cpp$(DependSuffix) -MM "common/ResourcePool.cpp"

$(IntermediateDirectory)/common_ResourcePool.cpp$(PreprocessSuffix): common/ResourcePool.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/common_ResourcePool.cpp$(PreprocessSuffix) "common/ResourcePool.cpp"
...
$(IntermediateDirectory)/owcmn_owcmn.cpp$(ObjectSuffix): owcmn/owcmn.cpp $(IntermediateDirectory)/owcmn_owcmn.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "E:/projects/graphics/core/owcmn/owcmn.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/owcmn_owcmn.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/owcmn_owcmn.cpp$(DependSuffix): owcmn/owcmn.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/owcmn_owcmn.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/owcmn_owcmn.cpp$(DependSuffix) -MM "owcmn/owcmn.cpp"

$(IntermediateDirectory)/owcmn_owcmn.cpp$(PreprocessSuffix): owcmn/owcmn.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/owcmn_owcmn.cpp$(PreprocessSuffix) "owcmn/owcmn.cpp"
