...
$(IntermediateDirectory)/buffer.cpp$(ObjectSuffix): buffer.cpp $(IntermediateDirectory)/buffer.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "F:/gits/graphics/scriptEngine/buffer.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/buffer.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/lua_lbitlib.c$(ObjectSuffix): lua/lbitlib.c $(IntermediateDirectory)/lua_lbitlib.c$(DependSuffix)
	$(CC) $(SourceSwitch) "F:/gits/graphics/scriptEngine/lua/lbitlib.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/lua_lbitlib.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/lua_lcorolib.c$(ObjectSuffix): lua/lcorolib.c $(IntermediateDirectory)/lua_lcorolib.c$(DependSuffix)
	$(CC) $(SourceSwitch) "F:/gits/graphics/scriptEngine/lua/lcorolib.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/lua_lcorolib.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/lua_lctype.c$(ObjectSuffix): lua/lctype.c $(IntermediateDirectory)/lua_lctype.c$(DependSuffix)
	$(CC) $(SourceSwitch) "F:/gits/graphics/scriptEngine/lua/lctype.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/lua_lctype.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/lua_luac.c$(ObjectSuffix): lua/luac.c $(IntermediateDirectory)/lua_luac.c$(DependSuffix)
	$(CC) $(SourceSwitch) "F:/gits/graphics/scriptEngine/lua/luac.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/lua_luac.c$(ObjectSuffix) $(IncludePath)
